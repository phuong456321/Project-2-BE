    ...
    <div class="bg-gray-800 p-4 rounded-lg shadow-lg">
        ...
        <div class="flex flex-wrap gap-4 mb-4 items-center">
            ...
            <div class="flex flex-col flex-1">
                ...
                <input id="search" type="text" placeholder="Enter author name..." class="bg-gray-700 text-white py-2 px-4 rounded-md">
            </div>
        </div>
        <!-- Table for users -->
    ...
    <div class="bg-gray-800 rounded-lg shadow-lg w-full max-w-lg p-6">
        ...
        <form id="create-author-form" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input id="author-bio" type="text" name="bio" class="w-full bg-gray-700 text-white py-2 px-4 rounded-md">
            </div>
            <!-- Area -->
            <div class="mb-4">
